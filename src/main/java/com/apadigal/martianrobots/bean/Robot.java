...
import com.apadigal.martianrobots.constant.Movement;
import com.apadigal.martianrobots.constant.Orientation;
...
public class Robot {
    ...
    public Robot(String positionString, String strMovements) {
        ...
        this.movements = Arrays.stream(strMovements.split("")).map(Movement::valueOf).collect(Collectors.toList());
    }
